...
def test_required_project_contracts_exist() -> None:
    ...
    required = (
        ...
        "src/sodif/ui/pages/configuration.py",
        "src/sodif/ui/pages/security.py",
        "src/sodif/ui/pages/archive.py",
        "src/sodif/ui/pages/gateway.py",
        ...
        "src/sodif/pages/configuration.py",
        "src/sodif/pages/security.py",
        "src/sodif/pages/archive.py",
        "src/sodif/pages/gateway.py",
        "src/sodif/pages/reports.py",
        "src/sodif/pages/ingestion.py",
        "src/sodif/pages/registry.py",
        "src/sodif/reporting/service.py",
        "src/sodif/reporting/ledger.py",
        "src/sodif/reporting/persistence.py",
        "scripts/flight.ps1",
