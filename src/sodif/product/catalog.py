...
MODULES = (
    ProductModule(
        ...
        input_contract="Document semnat, dovezi de interpretare și acțiunea solicitată",
    ...
    ProductModule(
        ...
        promise="Păstrează documentul, reviziile și dovezile într-un istoric verificabil.",
        responsibility=(
        ...
        output_contract="Înregistrare indexată, istoric de revizii și pachet de dovezi",
